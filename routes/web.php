...
Route::post('/admin/categories/create', [CategoryController::class, 'store'])->middleware('auth')->name('admin-categories-create');

Route::get('/admin/categories/{id}/edit', [CategoryController::class, 'edit'])->middleware('auth')->name('admin-categories-edit');

Route::patch('/admin/categories/{id}/edit', [CategoryController::class, 'update'])->middleware('auth')->name('admin-categories-edit');

// posts


Route::get('/admin/posts', [PostController::class, 'index'])->middleware('auth')->name('admin-posts');

Route::get('/admin/posts/create', [PostController::class, 'create'])->middleware('auth')->name('admin-posts-create');

Route::post('/admin/posts/create', [PostController::class, 'store'])->middleware('auth')->name('admin-posts-create');

Route::get('/admin/posts/{id}/edit', [PostController::class, 'edit'])->middleware('auth')->name('admin-posts-edit');

Route::patch('/admin/posts/{id}/edit', [PostController::class, 'update'])->middleware('auth')->name('admin-posts-edit');
